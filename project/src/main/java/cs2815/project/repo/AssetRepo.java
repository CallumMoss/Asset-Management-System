...
public interface AssetRepo extends JpaRepository<Asset, Integer> { // Integer being the type of the primary key
    ...
    */
    ...
    /**
    * Retrieves the newest asset based on the maximum asset_id.
    * @return Newest asset.
    */
   ...
   */
    ...
    */
    ...
    void updateAssetFieldsById(@Param("assetID") int assetId, @Param("newTitle") String newTitle,
     ...
     /**
     * Sets Asset_type to null for an asset by its Asset_type ID.
     * @param AssetTypeId ID of the Asset_type.
     */
    @Modifying
    @Transactional
    ...
    /**
    * Removes a user ID from the dependency table.
    * @param belonging_id ID of the user to be removed from the dependency.
    */
    @Modifying
    @Transactional
    ...
    /**
    * Checks if an asset is dependent on another asset.
    * @param assetId ID of the asset.
    * @return List of asset IDs dependent on the given asset.
    */
    ...
    /**
    * Checks if an asset is the parent of another asset.
    * @param assetId ID of the asset.
    * @return List of asset IDs which are parents of the given asset.
    */
    ...
    /**
    * Retrieves assets by a specific author.
    * @param author Author of the assets.
    * @return List of assets by the given author.
    */
